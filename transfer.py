...
def arguments():
    ...
    parser = arg.ArgumentParser("JIRA to GitHub migrator")
...
def pipeline_setup(args):
    ...
    github_writer = gh.Writer(args.user_org_name, args.repository, args.token)
    ...
    convert_ticket.output_port.receiver = github_writer
